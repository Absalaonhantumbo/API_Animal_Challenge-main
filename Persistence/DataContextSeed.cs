...
namespace Persistence
{
    public class DataContextSeed
    {
        ...
        public static async Task SeedTerrestrialAsync(DataContext context, ILoggerFactory loggerFactory)
        {
            try
            {
                if(!context.TerrestrialTypes.Any())
                {
                    ...
                    foreach (var terrestrealType in terrestrialTypes)
                    {
                        await context.AddAsync(terrestrealType);
                    }
